...
import CheckoutWiring from './CheckoutWiring'; // G�� invisible helper that wires the Buy button
...
export default function ContestPage() {
  ...
  // Detect Gǣjust did something that earns pointsGǥ signals:
  ...
  const buttons = useMemo(() => ([
    ...
    },
    {
      id: 'buyBtn',
      label: 'Buy the Book',
      text: 'The adventureG��s greatG��and youG��re already living it.',
  ...
  return (
    ...
    >
      ...
      {/* GǣVIEW YOUR POINTSGǥ G�� animated component */}
      {showScoreButton && (
      ...
      >
        ...
        >
          Agnes Protocol tops banned book list G�� again G�� Jody Vernon breaks silence in viral
          interview G�� New points leader: Billy Bronski G�� 1,340 pts G�� Tapsy declares: GǣThis book
          changes everythingGǥ G�� Enter to win the 6-day dream vacation NOW!
        </span>
      </div>
