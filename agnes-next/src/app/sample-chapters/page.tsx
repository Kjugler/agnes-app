...
export default function SampleChaptersPage() {
  ...
  const buttons = [
    ...
    },
    {
      ...
      text: 'Fred enters the scene G�� Agnes already doesnG��t like him.',
      link: '/chapters/chapter2.pdf',
    },
    {
      id: 'btn3',
      label: 'Read Chapter 9',
      text: 'Meet Matt and Reese G�� straight from the orphanage.',
      link: '/chapters/chapter9.pdf',
    },
    {
      id: 'btn4',
      label: 'Read Chapter 45',
      text: 'Fred and Jody G�� always two steps ahead.',
      link: '/chapters/chapter45.pdf',
    },
    {
      id: 'btn5',
      label: 'Buy the Book',
      text: 'Enjoy the adventure G�� youG��re already living the reality.',
    },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <p>-� 2025 DeepQuill LLC G�� All Rights Reserved</p>
        <p>
          Contact:{' '}
