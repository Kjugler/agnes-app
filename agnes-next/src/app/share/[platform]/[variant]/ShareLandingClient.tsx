...
export default function ShareLandingClient() {
  ...
  const shareUrl = `${baseUrl}/share/${platform}/${variant}?ref=${encodeURIComponent(
    refCode
  )}&target=${target}`;
    ...
    >
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '0.75rem' }}>
              ...
              <span
                style={{
                  fontSize: '1rem',
                  color: videoDownloaded ? '#10b981' : hasCopied ? 'white' : '#94a3b8',
                }}
              >
      ...
      <button
        ...
        style={{
          ...
          borderRadius: 999,
          border: 'none',
          background: hasCopied ? '#10b981' : awardingPoints ? '#64748b' : '#3b82f6',
          color: 'white',
          fontSize: '1.1rem',
          fontWeight: 700,
      ...
      >
        {awardingPoints ? 'Awarding points...' : hasCopied ? '✓ Copied!' : 'Copy caption'}
      </button>
        ...
        <>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 999,
              border: 'none',
              background: pointsAwarded ? '#10b981' : awardingPoints ? '#64748b' : '#c026d3',
              color: 'white',
              fontSize: '1.1rem',
              fontWeight: 700,
          ...
          >
            {awardingPoints ? 'Awarding points...' : pointsAwarded ? '✓ Posted!' : 'I posted to Instagram'}
          </button>
        </>
      ) : (
        <button
