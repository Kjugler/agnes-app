    ...
    >
      <div
        style={{
          ...
          maxWidth: '600px',
          margin: '0 auto',
          marginTop: 'clamp(0.5rem, 4dvh, 2.5rem)',
          marginBottom: 'max(2rem, env(safe-area-inset-bottom, 0px))',
          borderRadius: '1rem',
          ...
          padding: '1.5rem',
          paddingBottom:
            'max(2rem, calc(1.5rem + env(safe-area-inset-bottom, 0px) + 4rem))',
          maxHeight:
            'calc(100dvh - 2rem - env(safe-area-inset-top, 0px) - env(safe-area-inset-bottom, 0px) - clamp(0.5rem, 4dvh, 2.5rem))',
          overflowY: 'auto',
          overflowX: 'hidden',
          WebkitOverflowScrolling: 'touch',
