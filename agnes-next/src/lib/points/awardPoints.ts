 ...
 * TypeScript version for agnes-next
 * 
 * Rules:
...
const REFERRAL_POINTS = 1000; // 1000 points per referral conversion

/**
 * Award purchase points with daily and lifetime caps
 */
export async function awardPurchaseDailyPoints({
  userId,
  purchaseId,
  now = new Date(),
}: {
...
export { PURCHASE_POINTS, REFERRAL_POINTS };
