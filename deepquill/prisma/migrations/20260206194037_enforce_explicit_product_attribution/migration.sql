...
INSERT INTO "new_ReferralConversion" ("amountPaidCents", "buyerEmail", "commissionCents", "createdAt", "currency", "id", "lastDigestDate", "product", "referralCode", "referrerUserId", "savingsCents", "stripeSessionId") SELECT "amountPaidCents", "buyerEmail", "commissionCents", "createdAt", "currency", "id", "lastDigestDate", "product", "referralCode", "referrerUserId", "savingsCents", "stripeSessionId" FROM "ReferralConversion";
